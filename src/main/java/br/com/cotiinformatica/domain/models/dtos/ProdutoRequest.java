...
public class ProdutoRequest {
	...
	@NotBlank(message = "Por favor, informe o nome do produto.") //não vazio
	@Size(min= 8, max = 150, message = "O nome deve ter de 8 a 150 caracteres.")
	private String nome;
	
	@NotNull(message = "Por favor, informe o preço do produto.")
	@Positive(message = "Por favor, informe o preço com o valor maior do que zero.")
	...
	@Pattern(
			...
			message = "A categpria deve ser INFORMÁTICA ou ELETRÔNICOS ou VESTUÁRIO ou PAPELARIA ou OUTROS."
			)
